...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Working Hours',
      details: ['Sun - Thu: 9:00 AM - 5:00 PM', 'Friday & Saturday: Closed'],
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-teal-500 to-purple-600 hover:from-teal-600 hover:to-purple-700 text-white px-8 py-4 rounded-lg font-semibold flex items-center justify-center transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                    Send Message
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Why Choose TechSolutions?</h3>
